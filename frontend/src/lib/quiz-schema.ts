...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  { id: "q01_genero", step: 1, type: "single_choice", title: "Qual seu genero?", options: [
    { id: "homem", label: "Homem" },
    { id: "mulher", label: "Mulher" },
    { id: "outro", label: "Outro" },
    { id: "prefiro_nao_dizer", label: "Prefiro nao dizer" },
  ]},
  { id: "q02_faixaEtaria", step: 2, type: "single_choice", title: "Qual sua faixa etaria?", options: [
    { id: "18_24", label: "18 — 24" },
    { id: "25_30", label: "25 — 30" },
    { id: "31_38", label: "31 — 38" },
    { id: "39_plus", label: "39+" },
  ]},
  { id: "q03_objetivoAtual", step: 3, type: "single_choice", title: "Hoje, seu foco e:", options: [
  ...
  { id: "q04_estiloAtual", step: 4, type: "single_choice", title: "Como voce avalia seu estilo atual?", options: [
  ...
  { id: "q05_aparenciaFotos", step: 5, type: "single_choice", title: "Como voce se sente com sua aparencia em fotos?", options: [
  ...
  { id: "q06_frequenciaCuidado", step: 6, type: "single_choice", title: "Com que frequencia cuida de cabelo, barba e pele?", options: [
    { id: "alta", label: "Sempre, toda semana" },
    { id: "media", label: "As vezes, sem rotina fixa" },
    { id: "baixa", label: "Quase nunca" },
  ]},
  { id: "q07_roupaDiaADia", step: 7, type: "single_choice", title: "Como costuma se vestir no dia a dia?", options: [
  ...
  { id: "q08_posturaExpressao", step: 8, type: "single_choice", title: "Sua postura e expressao transmitem mais:", options: [
    { id: "confianca", label: "Confianca" },
    { id: "neutralidade", label: "Neutralidade" },
    { id: "inseguranca", label: "Inseguranca" },
  ]},
  { id: "q09_primeiroContato", step: 9, type: "single_choice", title: "Como as pessoas te percebem no primeiro contato?", options: [
  ...
  { id: "q10_chamaAtencao", step: 11, type: "single_choice", title: "Voce sente que chama atencao quando chega em um ambiente?", options: [
    { id: "sempre", label: "Sim, quase sempre" },
    { id: "as_vezes", label: "As vezes" },
    { id: "quase_nunca", label: "Quase nunca" },
  ]},
  { id: "q11_bloqueioAtual", step: 12, type: "single_choice", title: "Qual seu maior bloqueio hoje para atracao?", options: [
  ...
  { id: "q12_tipoPessoa", step: 13, type: "single_choice", title: "Que tipo de pessoa voce quer atrair?", options: [
  ...
  { id: "q13_tempoMelhora", step: 14, type: "single_choice", title: "Em quanto tempo quer perceber melhora?", options: [
  ...
  { id: "q14_disposicaoAjustar", step: 15, type: "single_choice", title: "Quanto esta disposto(a) a ajustar nos proximos 7 dias?", options: [
